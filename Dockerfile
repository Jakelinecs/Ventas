...
RUN apt-get update && apt-get install -y \
    ...
    && docker-php-ext-configure pdo_pgsql --with-pdo_pgsql=pgadmin

# Una vez finalizado, borramos la caché y limpiamos los archivos de instalación
RUN apt-get clean && rm -rf /var/lib/apt/lists/*

# Instalamos las dependencias y extensiones PHP que necesitaremos en nuestro proyecto como: pdo_mysql, mbstring, exif, pcntl, bcmath, gd, sockets y pdo_pgsql
...
# Creamos un usuario de sistema para ejecutar los comandos Composer y Artisan
